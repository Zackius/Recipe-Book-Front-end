...
import { Wedding1 } from "../../assets/images";
  ...
  return (
    <div className="bg-primary-color pt-8 my-10 grid grid-cols-1 gap-20 md:grid-cols-2 w-4/5 mx-auto items-center px-8 rounded-lg">
      <div className="flex flex-col gap-2 mr-2">
        <hi className="text-3xl md:text-3xl lg:text-4xl xl:text-5xl font-bold">Bake, Cook, Save and Share </hi>
        <p className="md:text-base lg:text-lg pt-4">
           Balmy Recipe Book is a unique recipe sharing and discovery platform, where
      ...
      <div className="scale-125 pl-44 ">
        <img className="w-[300px] h-[300px] rounded-full" src={Wedding1} alt=""></img>
      </div>
    </div>
  );
}
